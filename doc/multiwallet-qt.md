...
In order to support loading of multiple wallets in idealgoldv2-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is idealgoldv2.cpp.
...
Changes to idealgoldv2.cpp
----------------------
idealgoldv2.cpp is the entry point into idealgoldv2-qt, and as such, will require some minor modifications to provide hooks for
