...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("idealgoldv2 Core idealgoldv2-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  idealgoldv2-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded idealgoldv2 transaction") + "\n" +
                               "  idealgoldv2-tx [options] -create [commands]   " + _("Create hex-encoded idealgoldv2 transaction") + "\n" +
                               "\n";
