...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop idealgoldv2 server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "idealgoldv2 server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* PIVX features */
        {"idealgoldv2", "masternode", &masternode, true, true, false},
        {"idealgoldv2", "listmasternodes", &listmasternodes, true, true, false},
        {"idealgoldv2", "getmasternodecount", &getmasternodecount, true, true, false},
        {"idealgoldv2", "masternodeconnect", &masternodeconnect, true, true, false},
        {"idealgoldv2", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"idealgoldv2", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"idealgoldv2", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"idealgoldv2", "masternodecurrent", &masternodecurrent, true, true, false},
        {"idealgoldv2", "masternodedebug", &masternodedebug, true, true, false},
        {"idealgoldv2", "startmasternode", &startmasternode, true, true, false},
        {"idealgoldv2", "createmasternodekey", &createmasternodekey, true, true, false},
        {"idealgoldv2", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"idealgoldv2", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"idealgoldv2", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"idealgoldv2", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"idealgoldv2", "getmasternodescores", &getmasternodescores, true, true, false},
        {"idealgoldv2", "mnbudget", &mnbudget, true, true, false},
        {"idealgoldv2", "preparebudget", &preparebudget, true, true, false},
        {"idealgoldv2", "submitbudget", &submitbudget, true, true, false},
        {"idealgoldv2", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"idealgoldv2", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"idealgoldv2", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"idealgoldv2", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"idealgoldv2", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"idealgoldv2", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"idealgoldv2", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"idealgoldv2", "checkbudgets", &checkbudgets, true, true, false},
        {"idealgoldv2", "mnsync", &mnsync, true, true, false},
        {"idealgoldv2", "spork", &spork, true, true, false},
        {"idealgoldv2", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> idealgoldv2-cli " + methodname + " " + args + "\n";
}
