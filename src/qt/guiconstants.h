...
#define QAPP_ORG_NAME "idealgoldv2"
#define QAPP_ORG_DOMAIN "idealgoldv2chain.org"
#define QAPP_APP_NAME_DEFAULT "idealgoldv2-Qt"
#define QAPP_APP_NAME_TESTNET "idealgoldv2-Qt-testnet"
