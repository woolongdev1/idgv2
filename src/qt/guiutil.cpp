...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a idealgoldv2 address (e.g. %1)").arg("S7VFR83SQbiezrW72hjcWJtcfip5krte2Z"));
...
{
    // return if URI is not valid or is no idealgoldv2: URI
...
{
    // Convert idealgoldv2:// to idealgoldv2:
    //
    //    Cannot handle this later, because idealgoldv2:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open idealgoldv2.conf with the associated application */
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "idealgoldv2.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for idealgoldv2.lnk
...
{
    return GetAutostartDir() / "idealgoldv2.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    if (!fAutoStart)
        ...
        if (!optionFile.good())
            return false;
        // Write a idealgoldv2.desktop file to the autostart directory:
        optionFile << "[Desktop Entry]\n";
        optionFile << "Type=Application\n";
        optionFile << "Name=idealgoldv2\n";
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the idealgoldv2 app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add idealgoldv2 app to startup item list
