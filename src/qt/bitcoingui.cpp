...
// Copyright (c) 2019 The idealgoldv2 developers
...

{
    ...
    QString windowTitle = tr("idealgoldv2 Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a idealgoldv2 address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and idealgoldv2: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDEALT"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About idealgoldv2 Core"), this);
    aboutAction->setStatusTip(tr("Show information about idealgoldv2 Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for idealgoldv2"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your idealgoldv2 addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified idealgoldv2 addresses"));
    ...
    openAction->setStatusTip(tr("Open a idealgoldv2: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the idealgoldv2 Core help message to get a list with possible idealgoldv2 command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("idealgoldv2 Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to idealgoldv2 network", "", count));
}
...
{
    QString strTitle = tr("idealgoldv2 Core"); // default title
