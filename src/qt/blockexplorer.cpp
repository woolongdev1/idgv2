...
{
    std::string genesisblockhash = "000007da0b28f66ffdf4f4f50dc3b56033f0a71babfbf1a4fc2d9512d7e91bbb";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (idealgoldv2.conf).");
            QMessageBox::warning(this, "idealgoldv2 Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
