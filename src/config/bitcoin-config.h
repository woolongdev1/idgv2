...
#define PACKAGE_BUGREPORT "www.idealgoldv2chain.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "idealgoldv2 Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "idealgoldv2 Core 1.7.5"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "idealgoldv2"
