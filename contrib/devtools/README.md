...
idealgoldv2-Project/idealgoldv2 repository.
...
Setup
---------
Configuring the github-merge tool for the idealgoldv2 repository is done in the following way:

    git config githubmerge.repository idealgoldv2-Project/idealgoldv2
...
A script to optimize png files in the idealgoldv2
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_idealgoldv2: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_idealgoldv2: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_idealgoldv2: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_idealgoldv2: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
